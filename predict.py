...
dE = E_solv - E_gas 
Auto-selects the best available model (model_smd > model1_compact)
"""
...
def predict_solvation_energy(
    ...
    checkpoint        : None (default; auto-selects 'model_smd' if its weights are present, else 'model1_compact'), 
